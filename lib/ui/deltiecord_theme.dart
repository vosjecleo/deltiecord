...
class DeltiecordPalette extends ThemeExtension<DeltiecordPalette> {
  ...
  static DeltiecordPalette forMode(DeltiecordThemeMode mode) => switch (mode) {
    ...
    DeltiecordThemeMode.dark => const DeltiecordPalette(
      background: Color(0xff22231f),
      rail: Color(0xff191a17),
      panel: Color(0xff191a17),
      surface: Color(0xff22231f),
      elevated: Color(0xff292a26),
      input: Color(0xff292a26),
      island: Color(0xff292a26),
      hover: Color(0xff30312c),
      divider: Color(0xff373832),
