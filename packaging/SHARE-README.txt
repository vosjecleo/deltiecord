Deltiecord v0.9.15 beta test bundle
================================

Linux AppImage:
  chmod +x Deltiecord-0.9.15-x86_64.AppImage
  ./Deltiecord-0.9.15-x86_64.AppImage

Debian/Ubuntu package:
  sudo apt install ./deltiecord_0.9.15_amd64.deb
