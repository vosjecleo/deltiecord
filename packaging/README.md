...
Install the Debian package with `sudo apt install ./dist/deltiecord_0.9.18_amd64.deb`.
...
Run the AppImage with `chmod +x dist/Deltiecord-0.9.18-x86_64.AppImage` followed by
`./dist/Deltiecord-0.9.18-x86_64.AppImage`. A working desktop Secret Service is
