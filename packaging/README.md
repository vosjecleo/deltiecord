...
Install the Debian package with `sudo apt install ./dist/deltiecord-0.9.22+69-linux-debian-amd64.deb`.
...
Run the AppImage with `chmod +x dist/deltiecord-0.9.22+69-linux-appimage-x86_64.AppImage` followed by
`./dist/deltiecord-0.9.22+69-linux-appimage-x86_64.AppImage`. A working desktop Secret Service is
