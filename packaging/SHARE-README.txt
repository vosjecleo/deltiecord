Deltiecord v0.9.16 beta test bundle
================================

Linux AppImage:
  chmod +x Deltiecord-0.9.16-x86_64.AppImage
  ./Deltiecord-0.9.16-x86_64.AppImage

Debian/Ubuntu package:
  sudo apt install ./deltiecord_0.9.16_amd64.deb
